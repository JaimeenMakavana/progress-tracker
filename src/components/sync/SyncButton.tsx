  ...
  if (!isConnected) {
    return (
      <button
        ...
        className={`flex items-center justify-center gap-2 px-3 sm:px-4 py-2 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors whitespace-nowrap ${className}`}
